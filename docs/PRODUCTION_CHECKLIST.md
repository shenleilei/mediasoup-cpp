...
|---|---|---:|---:|---:|---|---|---|
| 稳定性基线 | 24h 稳定运行 | 2 | 5 | 3 | 待定 | 待定 | 🔴 <3，高优先级 |
| 稳定性基线 | 弱网/断网恢复 | 2 | 5 | 3 | 待定 | 待定 | 🔴 <3，高优先级 |
| 核心媒体能力 | simulcast/SVC | 2 | 5 | 3 | 待定 | 待定 | 🔴 <3，高优先级 |
| 核心媒体能力 | BWE/拥塞控制 | 2 | 5 | 3 | 待定 | 待定 | 🔴 <3，高优先级 |
| 信令与房间能力 | 生命周期/权限 | 2 | 5 | 3 | 待定 | 待定 | 🔴 <3，高优先级 |
| 可观测性与运维 | 指标/日志/告警 | 2 | 5 | 3 | 待定 | 待定 | 🔴 <3，高优先级 |
| 多租户与安全 | 鉴权/隔离/审计 | N/A | N/A | N/A | - | - | 本轮不考虑 |
| 生态与开发效率 | SDK/API/文档 | 2 | 5 | 3 | 待定 | 待定 | 🔴 <3，高优先级 |
| 成本与扩展性 | 承载/扩容/成本 | N/A | N/A | N/A | - | - | 本轮不考虑 |
