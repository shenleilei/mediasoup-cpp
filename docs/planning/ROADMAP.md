...
| 1.7 | worker 黑盒验证文档 | P1 | 1d | `docs/qos/downlink/v3-worker-validation_cn.md` | 1.1 跑完 | 明确回答 pause 后 RTP 是否停发、resume 首帧时间 |
...
| 6.2 | `PRODUCTION_CHECKLIST.md` 更新 | P0 | 1d | `docs/operations/PRODUCTION_CHECKLIST.md` | 全部 | 可照做的上线检查清单 |
| 6.3 | `MONITORING_RUNBOOK.md` 更新 | P0 | 0.5d | `docs/operations/MONITORING_RUNBOOK.md` | 2.2 | 告警规则 + 处理流程 |
