...
- 路径：[src/mediasoup-worker-src](/root/mediasoup-cpp/src/mediasoup-worker-src)
- tag：`3.14.6`
...
- [worker/src](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src)
- [worker/include](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include)
- [worker/fbs](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/fbs)
- [doc](/root/mediasoup-cpp/src/mediasoup-worker-src/doc)

按职责划分，可以粗分成 6 层：

1. 进程入口与全局生命周期
   - [lib.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/lib.cpp)
   - [Worker.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/Worker.cpp)
2. Channel/IPC
   - [ChannelSocket.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/Channel/ChannelSocket.hpp)
   - [ChannelMessageRegistrator.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/ChannelMessageRegistrator.hpp)
3. 房间与对象图
   - [Router.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Router.hpp)
   - [Transport.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Transport.hpp)
4. 媒体对象
   - [Producer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Producer.hpp)
   - [Consumer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Consumer.hpp)
   - [SimulcastConsumer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/SimulcastConsumer.hpp)
   - [SvcConsumer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/SvcConsumer.hpp)
5. 网络与传输
   - [WebRtcTransport.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/WebRtcTransport.hpp)
   - [WebRtcServer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/WebRtcServer.hpp)
   - [RtpListener.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/RtpListener.hpp)
6. 拥塞控制与带宽分配
   - [TransportCongestionControlClient.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/TransportCongestionControlClient.hpp)
   - [TransportCongestionControlServer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/TransportCongestionControlServer.hpp)
...
主入口在 [lib.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/lib.cpp)：
...
[Worker.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/Worker.hpp) 和 [Worker.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/Worker.cpp) 说明：
...
[Shared.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Shared.hpp) 很小，但很重要。
...
[ChannelSocket.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/Channel/ChannelSocket.hpp) 定义了 worker 内部最重要的控制抽象：
...
[Worker.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/Worker.cpp) 的 `HandleRequest()` 只直接处理少数顶层方法：
...
[ChannelMessageRegistrator.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/ChannelMessageRegistrator.hpp) 本质上是：
...
[WebRtcServer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/WebRtcServer.hpp) 和 [WebRtcServer.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/WebRtcServer.cpp) 说明：
...
[Router.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Router.hpp) 是 worker 内部真正的媒体拓扑中枢。
...
在 [Router.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/Router.cpp) 里：
...
从 [Transport.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Transport.hpp) 可以看出，`Transport` 是一个超核心聚合类：
...
[RtpListener.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/RtpListener.hpp) 和 [RtpListener.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/RtpListener.cpp) 负责把 incoming RTP 归到某个 Producer。
...
[Producer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Producer.hpp) 对应的是：
...
[Consumer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Consumer.hpp) 定义了非常关键的抽象接口：
...
[Transport.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/Transport.cpp) 的 `TRANSPORT_CONSUME` 分支会按 `RtpParameters::Type` 创建：
...
[TransportCongestionControlClient.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/TransportCongestionControlClient.cpp) 里明确用了：
...
[TransportCongestionControlServer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/TransportCongestionControlServer.hpp) 和 [TransportCongestionControlServer.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/TransportCongestionControlServer.cpp) 负责：
...
[Transport.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/Transport.cpp) 有一个非常直接的内部算法：
...
[SimulcastConsumer.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/SimulcastConsumer.cpp) 里，`preferredSpatialLayer` / `preferredTemporalLayer` 只是“上界偏好”，不是最终直接下发层。
...
- 通过 [Consumer.cpp](/root/mediasoup-cpp/src/Consumer.cpp) 把 `pause/resume/setPreferredLayers/setPriority` 发给 worker
- 通过 [Producer.cpp](/root/mediasoup-cpp/src/Producer.cpp) 观测 score 与 stats
- 通过 [RoomService.cpp](/root/mediasoup-cpp/src/RoomService.cpp) 做 room 级管理与 QoS 聚合
...
1. [worker/src/lib.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/lib.cpp)
2. [worker/src/Worker.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/Worker.cpp)
3. [worker/include/Channel/ChannelSocket.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/Channel/ChannelSocket.hpp)
4. [worker/include/RTC/Router.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Router.hpp)
5. [worker/include/RTC/Transport.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Transport.hpp)
6. [worker/include/RTC/RtpListener.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/RtpListener.hpp)
7. [worker/include/RTC/Producer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Producer.hpp)
8. [worker/include/RTC/Consumer.hpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/include/RTC/Consumer.hpp)
9. [worker/src/RTC/TransportCongestionControlClient.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/TransportCongestionControlClient.cpp)
10. [worker/src/RTC/SimulcastConsumer.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/SimulcastConsumer.cpp)
11. [worker/src/RTC/SvcConsumer.cpp](/root/mediasoup-cpp/src/mediasoup-worker-src/worker/src/RTC/SvcConsumer.cpp)
