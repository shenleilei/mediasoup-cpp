...
- WebRTC QoS Plain P2 执行方案在 [webrtc-qos-push-play-client-p2-design_cn.md](./webrtc-qos-push-play-client-p2-design_cn.md)，其中 P2-M8b 把 `drop_recover` 清网后 15 秒内 decoded frames 增长列为恢复首帧硬门禁。
